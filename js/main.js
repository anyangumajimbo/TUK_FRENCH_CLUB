...
function setupContactForm() {
  ...
  contactForm.addEventListener('submit', function(e) {
    ...
    if (!nameInput.value.trim() || !emailInput.value.trim() || !subjectSelect.value || !messageInput.value.trim()) {
...
function setupMembershipForm() {
  ...
  membershipForm.addEventListener('submit', function(e) {
    ...
    if (!fullNameInput.value.trim() || !studentIdInput.value.trim() || !emailInput.value.trim() || !membershipTypeSelect.value) {
    ...
    setTimeout(() => {
      alert('Registration submitted! Please proceed to payment to complete your registration.');
